...
parameters {
        ...
        extendedChoice defaultValue: 'Vtune,Inspector,Advisor', multiSelectDelimiter: ',', name: 'Compenent Name', quoteValue: false, saveJSONParameterToFile: false, type: 'PT_CHECKBOX', value: 'Vtune,Inspector,Advisor', visibleItemCount: 4
...
stages {
           ...
           stage("checkout code") {
             ...
             steps {
              println "\033[34m............checkout code12345..............\033[0m"
              echo "checkout code"
             }
           }
